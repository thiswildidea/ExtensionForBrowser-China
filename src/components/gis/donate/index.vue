  ...
  <div>
    ...
    >
      <div class="donate-content">
        <p class="donate-text">如果您觉得这个扩展对您有帮助，请扫描下方二维码进行捐赠</p>
        ...
        <div class="qrcode-container">
          ...
          <p class="qrcode-hint">点击二维码可放大查看</p>
        <p class="payment-tip">{{ getPaymentTipText() }}</p>
        </div>
        <p class="donate-thank">感谢您的支持！</p>
      </div>
    </el-dialog>
...
export default {
	...
	setup() {
		...
		const handleImageError = () => {
			...
			ElMessage.error('二维码图片加载失败，请确保图片路径正确');
		};
